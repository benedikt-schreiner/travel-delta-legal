...
Travel Delta n'utilise aucun SDK d'analyse, de traçage ou de publicité. Aucun profil d'utilisation n'est créé.

## 7. Transferts internationaux de données

Supabase peut traiter des données sur des serveurs aux États-Unis. Supabase Inc. est certifiée dans le cadre du Data Privacy Framework UE–États-Unis. Seuls des codes pays non personnels sont transmis.
