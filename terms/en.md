---
layout: default
title: Terms of Use — Travel Delta
lang: en
---

[Deutsch](de.html) · [English](en.html)

# Terms of Use

## § 1 Scope of Application

These Terms of Use apply to the use of the mobile application "Travel Delta". By using the app, the user agrees to these terms.

## § 2 Nature of the Service

Travel Delta provides general travel information and is not a booking portal. All information regarding entry requirements, currency rates, emergency numbers, traffic rules, pet travel rules, and other travel data is provided for general orientation purposes only.

## § 3 Rights of Use (License)

Travel Delta grants the user a simple (non-exclusive), non-transferable right to install and use the app on their own devices within the scope of its intended use. A revocation or restriction of this right of use will only occur for good cause, in particular in the event of violations of these Terms of Use (see § 10). Any reproduction, modification, decompilation, reverse engineering, or distribution of the app to third parties is prohibited, unless expressly permitted by law.

## § 4 In-App Purchases and Premium Features
...
Travel Delta shall be liable without limitation in cases of intent and gross negligence, as well as for damages resulting from injury to life, body, or health. In the event of a slightly negligent breach of essential contractual obligations (cardinal obligations, i.e., obligations whose fulfillment is essential for the proper execution of the contract and on the observance of which the user may regularly rely), liability is limited to the foreseeable, typical contractual damage. Otherwise, liability is excluded.

The information provided in the app has been compiled with the greatest possible care. However, no guarantee is given for its accuracy, completeness, or timeliness. In particular, the following applies:

- Entry requirements and visa regulations may change at short notice – official sources (e.g., the Federal Foreign Office) must be checked before traveling.
...
The app may link to third-party content or services (e.g., partner offers, external websites). Travel Delta assumes no responsibility for the external content and privacy practices of third parties.

## § 8 No Professional or Legal Advice

The app content does not replace legal, tax, medical, veterinary, or official travel advice. In the case of legal, health-related or veterinary questions, appropriate professionals must be consulted.

## § 9 Data Protection

Information on the collection, processing, and use of personal data can be found in the separate Privacy Policy, which is accessible within the app and on this website.

## § 10 Termination and Suspension of Use

Travel Delta reserves the right to fully or partially suspend or restrict access to the app in the event of violations of these Terms of Use, in particular in the case of abusive or unlawful use. The user can terminate the use of the app at any time by uninstalling it.
